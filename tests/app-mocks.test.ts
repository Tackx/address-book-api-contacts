...
const mockCreate = ContactsService.create as jest.MockedFunction<typeof ContactsService.create>;
mockCreate.mockResolvedValue(<Reference>(<unknown>'Mocked created contact return'));
